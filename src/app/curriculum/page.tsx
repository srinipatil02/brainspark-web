    ...
    topics: [
      {
        ...
        questionCount: 10,
        isRich: true,
        setIds: ['year8-math-linear-equations-set1'],
      },
      { id: 'algebra', title: 'Algebra', description: 'Equations, expressions, and functions', questionCount: 25, setIds: [] },
      { id: 'geometry', title: 'Geometry', description: 'Shapes, angles, and measurements', questionCount: 20, setIds: [] },
      { id: 'statistics', title: 'Statistics', description: 'Data analysis and probability', questionCount: 15, setIds: [] },
      { id: 'number-theory', title: 'Number Theory', description: 'Integers, primes, and divisibility', questionCount: 18, setIds: [] },
    ],
  },
  {
    id: 'science',
