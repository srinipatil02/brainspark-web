...
/**
 * Upload Year 8 States of Matter questions to Firebase
 *
 * Usage:
 *   export GOOGLE_APPLICATION_CREDENTIALS="path/to/serviceAccount.json"
 *   node scripts/upload-states-of-matter.js
 */
...
async function uploadQuestions() {
  console.log('📚 Uploading Year 8 States of Matter Questions...\n');

  // Read the questions file
  const questionsPath = path.join(__dirname, 'year8-states-of-matter-questions.json');
  ...
  console.log('  Set 1: Particle Model (Q1-10)');
  console.log('  Set 2: Solid State (Q11-20)');
  console.log('  Set 3: Liquid State (Q21-30)');
  console.log('  Set 4: Gas State (Q31-40)');
  console.log('  Set 5: State Changes (Q41-50)');
  console.log('\nAll questions tagged with setId: year8-science-states-of-matter-medium');
}
