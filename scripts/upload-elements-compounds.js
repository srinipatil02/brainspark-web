...
/**
 * Upload Year 8 Elements & Compounds questions to Firebase
 *
 * Usage:
 *   export GOOGLE_APPLICATION_CREDENTIALS="path/to/serviceAccount.json"
 *   node scripts/upload-elements-compounds.js
 */
...
async function uploadQuestions() {
  console.log('📚 Uploading Year 8 Elements & Compounds Questions...\n');

  // Read the questions file
  const questionsPath = path.join(__dirname, 'year8-elements-compounds-questions.json');
  ...
  console.log('  Set 1: Atoms & Elements (Q1-10)');
  console.log('  Set 2: Periodic Table (Q11-20)');
  console.log('  Set 3: Compounds & Mixtures (Q21-30)');
  console.log('  Set 4: Chemical Formulas (Q31-40)');
  console.log('  Set 5: Elements in Everyday Life (Q41-50)');
  console.log('\nAll questions tagged with setId: year8-science-elements-compounds-medium');
}
