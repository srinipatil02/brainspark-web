...
/**
 * Upload Year 8 Chemical Reactions questions to Firebase
 *
 * Usage:
 *   export GOOGLE_APPLICATION_CREDENTIALS="path/to/serviceAccount.json"
 *   node scripts/upload-chemical-reactions.js
 */
...
async function uploadQuestions() {
  console.log('📚 Uploading Year 8 Chemical Reactions Questions...\n');

  // Read the questions file
  const questionsPath = path.join(__dirname, 'year8-chemical-reactions-questions.json');
  ...
  console.log('  Set 1: Physical vs Chemical Changes (Q1-10)');
  console.log('  Set 2: Types of Reactions (Q11-20)');
  console.log('  Set 3: Conservation of Mass (Q21-30)');
  console.log('  Set 4: Reaction Rates (Q31-40)');
  console.log('  Set 5: Everyday Reactions (Q41-50)');
  console.log('\nAll questions tagged with setId: year8-science-chemical-reactions-medium');
}
